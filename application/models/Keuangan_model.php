...
class Keuangan_model extends CI_Model
{
    ...
    function ajax_obat($noRawat) {
        ...
        return $this->datatables
                    ...
                    ->add_column('action', "$approve_html", "MjAyMC8wOS8yMy8wMDA0")
    ...
    function set_status($no_rawat, $status = 2) {
        return $this->update_data(['no_rawat' => dec_str($no_rawat)], ["id_status_acc" => $status], "tbl_riwayat_pemberian_obat");
    }
