    ...
    <section class="content">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo '  '; 
				echo anchor(site_url('pengadaan/delete/'.$pengadaan->no_faktur),'<i class="fa fa-trash-o" aria-hidden="true"></i>','class="btn btn-danger btn-sm" Delete','onclick="javascript: return confirm(\'Apakah Anda yakin?\')"'); 
				?>
			</td>
		</tr>
                <?php
