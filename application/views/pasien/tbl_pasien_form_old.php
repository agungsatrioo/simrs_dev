                ...
                <div class="box box-warning box-solid">
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                                ...
                                <table class='table table-bordered'>
                                        <tr>
                                                <td width='200'>No Rekemedis <?php echo form_error('no_rekemedis') ?></td>
                                                <td><input type="text" class="form-control" id="no_rekamedis" placeholder="No Rekemedis" name="no_rekamedis" value="<?php echo $no_rekamedis ?>" /> </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        <?=
                                                                cmb_dinamis('id_gol_darah', 'tbl_gol_darah', 'nama_gol_darah', 'id_gol_darah', $id_gol_darah)
                                                        ?>
                                        <tr>
                                        ...
                                        <tr>
                                                <td width='200'>Agama <?php echo form_error('id_agama') ?></td>
                                                <td>
                    ...
                    <tr><td width='200'>Status Menikah <?php echo form_error('status_menikah') ?></td><td><input type="text" class="form-control" name="status_menikah" id="status_menikah" placeholder="Status Menikah" value="<?php echo $status_menikah; ?>" />-->
                                                </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                <td width='200'>Pekerjaan <?php echo form_error('id_pekerjaan') ?></td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="<?php echo base_url('pasien') ?>" class="btn btn-info"><i class="fa fa-sign-out-alt"></i> Kembali</a></td>
                                        </tr>
                                </table>
                        </form>
                </div>
