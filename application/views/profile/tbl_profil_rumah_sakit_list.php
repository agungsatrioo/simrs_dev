<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('profile/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?></div>
            </div>
            <div class='col-md-3'>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo '  '; 
				echo anchor(site_url('profile/update/'.$profile->id),'<i class="fa fa-pen" aria-hidden="true"></i>','class="btn btn-danger btn-sm"'); 
				echo '  '; 
				echo anchor(site_url('profile/delete/'.$profile->id),'<i class="fa fa-trash-alt" aria-hidden="true"></i>','class="btn btn-danger btn-sm" Delete','onclick="javascript: return confirm(\'Apakah Anda yakin?\')"'); 
				?>
			</td>
		</tr>
                <?php
