                ...
                <div class="box box-warning box-solid">
                        ...
                        <form action="<?php echo $action; ?>" method="post">
                                <table class='table table-bordered'>
                                        <tr>
                                                <td width='200'>Kode Dokter <?php echo form_error('kode_dokter') ?></td>
                                        ...
                                        <tr>
                                                <td width='200'>Status Menikah <?php echo form_error('id_status_menikah') ?></td>
                                                <td>
                                        ...
                                        <tr>
                                                <td width='200'>Golongan Darah <?php echo form_error('id_gol_darah') ?></td>
                                                <td>
                                                       <?=
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="<?php echo site_url('dokter') ?>" class="btn btn-info"><i class="fa fa-sign-out-alt"></i> Kembali</a></td>
                                        </tr>
                                </table>
                        </form>
                </div>
